...
public class ScrollingTable extends LinearLayout {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		TableLayout header = (TableLayout) findViewById(R.id.tlTableHeader);
		TableLayout body = (TableLayout) findViewById(R.id.tlSqliteSql);

		// MIA IMPLEMENTAZIONE CERCO DI RENDERE UGUALI LE DIMENSIONI DELLA PRIMA
		// RIGA
		// DELLE DUE TABLELAYOUT
