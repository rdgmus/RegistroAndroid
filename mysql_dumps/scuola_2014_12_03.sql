...
--
-- Host: localhost
-- Generation Time: Dic 03, 2014 alle 13:49
-- Versione del server: 5.6.20
-- PHP Version: 5.5.15

--
-- RegistroAndroid v0.6-alpha
--
...
-- Database: `scuola`
--
CREATE DATABASE IF NOT EXISTS `scuola` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `scuola`;
...
--
-- Creazione: Set 28, 2014 alle 13:58
--
...
DROP TABLE IF EXISTS `anagrafe_insegnanti`;
...
DROP TABLE IF EXISTS `anagrafe_studenti`;
...
--
DROP VIEW IF EXISTS `assenze_studenti`;
...
--
-- Creazione: Ott 22, 2014 alle 17:52
--
...
--
DROP TRIGGER IF EXISTS `elapsed_day_calc`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `store_user_email`;
DELIMITER //
...
--
-- Creazione: Ott 13, 2014 alle 08:59
--
...
--
-- Creazione: Ott 17, 2014 alle 10:59
--
...
--
-- Creazione: Ott 11, 2014 alle 20:54
--

DROP TABLE IF EXISTS `email_server_params`;
...
--
-- Creazione: Nov 01, 2014 alle 11:14
--
...
-- Trigger `email_store`
--
DROP TRIGGER IF EXISTS `email_inviata_data`;
DELIMITER //
...
--
DROP VIEW IF EXISTS `lezioni_materia`;
...
--
-- Creazione: Ott 27, 2014 alle 18:07
--

DROP TABLE IF EXISTS `log_msg_body`;
...
--
-- Creazione: Ott 27, 2014 alle 18:06
--
...
--
DROP TRIGGER IF EXISTS `upper_msg_type`;
DELIMITER //
...
--
-- Creazione: Ott 12, 2014 alle 20:06
--

DROP TABLE IF EXISTS `mysql_servers_groups`;
...
--
-- Creazione: Ott 12, 2014 alle 20:12
--

DROP TABLE IF EXISTS `mysql_server_params`;
...
--
-- Creazione: Ott 05, 2014 alle 22:12
--
...
--
DROP TRIGGER IF EXISTS `ins_ruolo_registri_granted`;
DELIMITER //
...
--
DROP VIEW IF EXISTS `registri_insegnanti`;
...
--
-- Creazione: Ott 05, 2014 alle 08:40
--
...
--
DROP TRIGGER IF EXISTS `ins_ruolo_ruoli_granted_to_utenti`;
DELIMITER //
CREATE TRIGGER `ins_ruolo_ruoli_granted_to_utenti` BEFORE INSERT ON `ruoli_granted_to_utenti`
 FOR EACH ROW set NEW.ruolo = (SELECT `ruolo` FROM `ruoli_utenti` WHERE `id_ruolo` = NEW.id_ruolo)
//
DELIMITER ;
DROP TRIGGER IF EXISTS `updt_ruolo`;
DELIMITER //
CREATE TRIGGER `updt_ruolo` BEFORE UPDATE ON `ruoli_granted_to_utenti`
 FOR EACH ROW set NEW.ruolo = (SELECT `ruolo` FROM `ruoli_utenti` WHERE `id_ruolo` = NEW.id_ruolo)
//
DELIMITER ;
...
--
-- Creazione: Nov 30, 2014 alle 12:27
--
...
`id_ruolo` bigint(20) NOT NULL,
  ...
  `img64` longblob COMMENT 'Immagne associata al ruolo da 64 pixels',
  `img48` longblob COMMENT 'immagine a 48 pixel'
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;
...
--
-- Creazione: Ott 28, 2014 alle 11:28
--
...
--
-- Creazione: Nov 22, 2014 alle 13:51
--
...
`id_utente` bigint(20) NOT NULL,
  ...
  `password` longtext,
  `hash` longtext COMMENT 'hash conferma email',
  `register_date` timestamp NULL DEFAULT NULL COMMENT 'Ora della registrazione',
  `user_is_admin` tinyint(1) NOT NULL DEFAULT '0',
  `has_to_change_password` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'Messo a 1 quando cambi password',
  `is_locked` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'Se a 1 previene l''accesso con le stesse credenziali',
  `email_confirmed` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'Ha confermato la sua email nelle prime 24 ore'
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=61 ;

--
-- Trigger `utenti_scuola`
--
DROP TRIGGER IF EXISTS `upper_cognome_nome`;
DELIMITER //
...
--
ALTER TABLE `ruoli_granted_to_utenti`
MODIFY `id_ruoli_granted` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=169;
--
...
--
ALTER TABLE `utenti_logger`
MODIFY `id_log` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15562;
--
-- AUTO_INCREMENT for table `utenti_scuola`
--
ALTER TABLE `utenti_scuola`
MODIFY `id_utente` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=61;
--
